...
system_install()
{
    ...
    arch-chroot /mnt reflector --sort rate --save /etc/pacman.d/mirrorlist -c "United States" -f 5 -l 5 # Set mirrors
    arch-chroot /mnt ln -sf /usr/share/zoneinfo/America/Chicago /etc/localtime # Set timezone
    arch-chroot /mnt hwclock --systohc --utc # Set system clock
