...
sudo -u $user_name pacaur -S xf86-video-intel mesa-libgl lib32-mesa-libgl xf86-input-libinput xorg-server xorg-xinit alsa-utils --noconfirm --noedit
sudo -u $user_name pacaur -S mpv qt4 shutter feh compton htop screenfetch ranger networkmanager lxappearance xdg-user-dirs ntfs-3g dosfstools unzip p7zip xorg-xprop xorg-xwininfo i3-gaps i3blocks i3lock-fancy-git --noconfirm --noedit
