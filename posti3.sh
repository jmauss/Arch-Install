...
sudo -u $user_name aurman -S arc-gtk-theme gnome-themes-extra paper-icon-theme-git papirus-icon-theme numix-circle-icon-theme-git --noedit --noconfirm --needed # Themes
