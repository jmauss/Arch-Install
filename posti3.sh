...
sudo -u $user_name pacaur -S mpv qt4 shutter feh compton htop screenfetch ranger lxappearance xdg-user-dirs ntfs-3g dosfstools unzip p7zip xorg-utils i3-gaps i3blocks i3lock-fancy-git --noconfirm --noedit
