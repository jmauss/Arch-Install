...
sudo -u $user_name pikaur -S feh compton htop screenfetch ranger lxappearance --noedit --noconfirm --needed
...
sudo -u $user_name pikaur -S ttf-roboto ttf-roboto-mono ttf-liberation noto-fonts noto-fonts-cjk noto-fonts-emoji ttf-font-awesome-4 gnome-themes-extra paper-icon-theme-git papirus-icon-theme-git numix-circle-icon-theme-git --noedit --noconfirm --needed
sudo -u $user_name pikaur -S thermald termite rofi qt4 qt5-styleplugins qt5ct --noedit --noconfirm --needed
